                ...
                <div class="col-xs-12 col-sm-12 col-md-3" style="margin-top: 10px; //border: 1px solid red">
                    <div class="form-group">
                        @if (Storage::has('profile_images/'.Auth::user()->id))
                            <img src="data:image/jpeg;base64,{{ base64_encode(Storage::get('profile_images/'.Auth::user()->id)) }}" style="//width: 90px; //heigth: 90px; width: 100%;" class="img-rounded">
                        @else
                            <img src="{{ url('images/icons/user.png') }}" style="//width: 90px; //heigth: 90px; width: 100%;" class="img-rounded" alt="">
                        @endif
                    </div>
                </div>
