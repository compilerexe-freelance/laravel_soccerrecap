        ...
        @for ($i = 0; $i <= 11; $i++)
            @foreach ($list_month[$i] as $month)
                ...
                @php
                    ...
                    //$story = \App\Story::where('id', $month)->orderBy('created_at', 'desc')->first();
                            ...
                            <span style="font-size: 24px;" class="font-color-gray">
                                ...
                                @php
                                    ...
                                    if ($month_name == "January") {
                                        echo __('messages.january');
                                    } else if ($month_name == "February") {
                                        echo __('messages.february');
                                    } else if ($month_name == "March") {
                                        echo __('messages.march');
                                    } else if ($month_name == "April") {
                                        echo __('messages.april');
                                    } else if ($month_name == "May") {
                                        echo __('messages.may');
                                    } else if ($month_name == "June") {
                                        echo __('messages.june');
                                    } else if ($month_name == "July") {
                                        echo __('messages.july');
                                    } else if ($month_name == "August") {
                                        echo __('messages.august');
                                    } else if ($month_name == "September") {
                                        echo __('messages.september');
                                    } else if ($month_name == "October") {
                                        echo __('messages.october');
                                    } else if ($month_name == "November") {
                                        echo __('messages.november');
                                    } else {
                                        echo __('messages.december');
                                    }
