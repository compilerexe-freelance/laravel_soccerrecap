        ...
        <div class="panel-body">
            ...
            <div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-2" style="//border: 1px solid red;">
                ...
                <div class="form-group text-right">
                    <a href="{{ url('/') }}"><button type="button" class="btn btn-bg-white font-color-blue border-blue" style="font-size: 16px; width: 150px;"><i class="fa fa-angle-double-left"></i> @lang('messages.back')</button></a>
                </div>
                ...
                <form action="{{ url('posts/new') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group text-center" style="margin-top: 30px;">
                        <button type="submit" class="btn btn-success btn-bg-blue border-blue" style="width: 150px; font-size: 16px;">@lang('messages.publish') <i class="fa fa-paper-plane"></i></button>
                    </div>
